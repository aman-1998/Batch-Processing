...
import personal.learning.app.job.parameter.JobParameterForOutputFile;
...
public class JobController {
	...
	public ResponseEntity<Object> startJob(@PathVariable("jobName") String jobName, @RequestBody JobParameterForOutputFile jobParameterForOutputFile) {
...
//																	.toJobParameters();
			...
			params.put("outputFile", new JobParameter(jobParameterForOutputFile.getOutputFileLocation()));
