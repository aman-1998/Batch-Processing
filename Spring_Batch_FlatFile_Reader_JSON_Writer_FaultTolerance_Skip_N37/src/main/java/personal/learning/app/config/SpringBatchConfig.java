...
//								 .build();
	...
	@StepScope
	@Bean
	public JsonFileItemWriter<Student> jsonFileItemWriter(@Value("#{jobParameters['outputFile']}") FileSystemResource fileSystemResource) {
		
		JsonFileItemWriter<Student> jsonFileItemWriter = new JsonFileItemWriter<Student>(fileSystemResource, new JacksonJsonObjectMarshaller<Student>());
