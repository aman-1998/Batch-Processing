...
import personal.learning.app.job.parameter.JobParameterForInputOutputFile;
...
public class JobController {
	...
	public ResponseEntity<Object> startJob(@PathVariable("jobName") String jobName, @RequestBody JobParameterForInputOutputFile jobParameterForInputOutputFile) {
...
//																	.toJobParameters();
			...
			params.put("inputFile", new JobParameter(jobParameterForInputOutputFile.getInputFileLocation()));
			params.put("outputFile", new JobParameter(jobParameterForInputOutputFile.getOutputFileLocation()));
