 ...
 * 
 * We can package the application in jar format. and then run the command:-
...
//	}
	...
	public CommandLineRunner commandLineRunner() {
		...
		return args -> {
			JobParameters jobParameters = new JobParametersBuilder().addString("Credit Bank Name", "CITY Bank")
					  .addString("Debit Bank Name", "ICICI Bank")
					  .toJobParameters();
